      ...
      self.edit = async (req, callback) => {
         ...
         function convert () {
            return new Promise((done, fail) => {
               self.apos.schemas.convert(req, self.udpateSchema, 'form', req.body, piece, (err, response) => {
                  if (err) {
         ...
         function update () {
            return new Promise((done, fail) => {
               self.apos.docs.db.update({ slug: piece.slug, type: 'subscription' }, { $set: piece }, (err) => {
                  if (err) {
                     return fail(new Error(err));
                  }
